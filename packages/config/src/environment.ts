...
export const environmentSchema = z.object({
  ...
  // MongoDB - defaults match docker-compose.yml
  MONGODB_URI: z.string().default("mongodb://localhost:27017"),
  MONGODB_USERNAME: z.string().default("admin"),
  MONGODB_PASSWORD: z.string().default("changeme"),
  MONGODB_DATABASE: z.string().default("price_comparison"),
  ...
  MEILISEARCH_MASTER_KEY: z
    .string()
    .default("changeme_master_key_min_16_chars"),
